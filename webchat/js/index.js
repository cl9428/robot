...
mui.ajax('http://c.m.163.com/nc/article/headline/T1348647853363/0-20.html?from=toutiao',{
	dataType:'json',
	type:'get',
	timeout:10000,
...
//列表数据请求
	...
	mui.ajax('http://c.m.163.com/nc/article/headline/T1348647853363/0-40.html?from=toutiao',{
		dataType:'json',
		type:'get',
		timeout:10000,
		success:function(data){
...
function listDataAnalyze(data){
	...
	for(var i = 0; i<arrayObj.length;i++){
		finalList = '<li class="mui-table-view-cell mui-media list-cell"><a href="#"><img class="mui-media-object mui-pull-left" src='+arrayObj[i].imgsrc+'><div class="mui-media-body">'+arrayObj[i].title+'<p class="mui-ellipsis">'+arrayObj[i].digest+'</p></div></a></li>';
	...
	$(document).on('tap','.list-cell',function(){
		mui.openWindow({
			...
			//自定义参数处理页面间传值
			 extras:{
	       	listName:arrayObj[$(this).index()].docid,
	    }
		})
	})
}
...
//		//路径转换
 ...
 function onNetChange() {
   ...
   //列表数据请求
   //http://c.m.163.com/nc/article/headline/T1348647853363/30-20.html?from=toutiao&passport=&devId=OPdeGFsVSojY0ILFe6009pLR%2FMsg7TLJv5TjaQQ6Hpjxd%2BaWU4dx4OOCg2vE3noj&size=20&version=5.5.3&spever=false&net=wifi&lat=&lon=&ts=1456985878&sign=oDwq9mBweKUtUuiS%2FPvB015PyTDKHSxuyuVq2076XQB48ErR02zJ6%2FKXOnxX046I&encryption=1&canal=appstore
		mui.ajax('http://c.m.163.com/nc/article/headline/T1348647853363/30-20.html?from=toutiao',{
			dataType:'json',
			type:'get',
			timeout:10000,
			success:function(data){
